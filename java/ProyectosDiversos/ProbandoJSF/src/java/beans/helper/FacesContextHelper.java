...
public class FacesContextHelper {
    public static void limpiarFacesMessages(FacesContext facesContext, String clienteId){
        Iterator<FacesMessage> facesMessages = facesContext.getMessages(clienteId);
